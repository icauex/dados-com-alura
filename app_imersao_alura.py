...
# seleçao tamanho da empresa
tamanho_disponiveis = sorted(df['tamanho_empresa'].unique())
tamanho_selecionados = st.sidebar.multiselect(
    'Tamanho da Empresa', tamanho_disponiveis, default=tamanho_disponiveis)
...
# Conteudo principal ("o que fica em evidência no dashboard")
...
if not df_filtrado.empty:
    ...
    salario_maximo, salario_medio, salario_mediano, total_registros, cargo_mais_comum = 0, 0, 0, ''
...
# Analises visuais com plotly (gráficos)
